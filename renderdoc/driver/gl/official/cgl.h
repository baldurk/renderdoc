...
#if __has_attribute(objc_bridge) && __has_feature(objc_bridge_id) && \
...
typedef enum _CGLGPURestartStatus { /* GPU Restart Status */
                                    kCGLCPGPURestartStatusNone =
                                        0, /* current context has not caused recent GPU restart */
                                    kCGLCPGPURestartStatusCaused = 1, /* current context caused
                                                                         recent GPU restart
                                                                         (auto-clear on query) */
                                    kCGLCPGPURestartStatusBlacklisted =
                                        2, /* current context is being ignored for excessive GPU
                                              restarts (won't clear on query) */
} CGLGPURestartStatus;
...
typedef enum _CGLContextParameter {
  ...
  /* Note: kCGLCPClientStorage is always a pointer-sized parameter, even though the API claims
     GLint. */
  ...
  kCGLCPGPURestartStatus =
      317, /* 1 param.   Retrieves and clears the current CGLGPURestartStatus */
  kCGLCPAbortOnGPURestartStatusBlacklisted =
      318, /* 1 param.  Establish action to take upon blacklisting */
  kCGLCPSupportGPURestart =
      319, /* 1 param.   Does driver support auto-restart of GPU on hang/crash? */
  kCGLCPSupportSeparateAddressSpace =
      320, /* 1 param. Does context get its own GPU address space?   */
  kCGLCPContextPriorityRequest =
      608, /* 1 param. kCGLCPContextPriorityRequest[High|Normal|Low] 0|1|2 */
} CGLContextParameter;
...
#define kCGLRGBA16161616Bit                                                                        \
  0x00800000                           /* 64 argb bit/pixel,   R=63:48, G=47:32, B=31:16, A=15:0 \ \
                                          */
...
extern CGLError CGLChoosePixelFormat(const CGLPixelFormatAttribute *attribs,
                                     CGLPixelFormatObj OPENGL_NULLABLE *OPENGL_NONNULL pix,
                                     GLint *npix);
...
extern CGLError CGLQueryRendererInfo(GLuint display_mask,
                                     CGLRendererInfoObj OPENGL_NULLABLE *OPENGL_NONNULL rend,
                                     GLint *nrend);
...
extern CGLError CGLDescribeRenderer(CGLRendererInfoObj rend, GLint rend_num,
                                    CGLRendererProperty prop, GLint *OPENGL_NULLABLE value);

/*
** Context functions
*/
extern CGLError CGLCreateContext(CGLPixelFormatObj pix, CGLContextObj OPENGL_NULLABLE share,
                                 CGLContextObj OPENGL_NULLABLE *OPENGL_NONNULL ctx);
...
** PBuffer functions
*/
extern CGLError CGLCreatePBuffer(GLsizei width, GLsizei height, GLenum target,
                                 GLenum internalFormat, GLint max_level,
                                 CGLPBufferObj OPENGL_NULLABLE *OPENGL_NONNULL pbuffer);
extern CGLError CGLDestroyPBuffer(CGLPBufferObj pbuffer);
extern CGLError CGLDescribePBuffer(CGLPBufferObj obj, GLsizei *width, GLsizei *height,
                                   GLenum *target, GLenum *internalFormat, GLint *mipmap);
...
** Drawable Functions
*/
extern CGLError CGLSetOffScreen(CGLContextObj ctx, GLsizei width, GLsizei height, GLint rowbytes,
                                void *baseaddr);
extern CGLError CGLGetOffScreen(CGLContextObj ctx, GLsizei *width, GLsizei *height, GLint *rowbytes,
                                void *OPENGL_NULLABLE *OPENGL_NONNULL baseaddr);
...
extern CGLError CGLSetPBuffer(CGLContextObj ctx, CGLPBufferObj pbuffer, GLenum face, GLint level,
                              GLint screen);
extern CGLError CGLGetPBuffer(CGLContextObj ctx,
                              CGLPBufferObj OPENGL_NULLABLE *OPENGL_NONNULL pbuffer, GLenum *face,
                              GLint *level, GLint *screen);
...
extern CGLError CGLSetSurface(CGLContextObj OPENGL_NULLABLE gl, CGSConnectionID cid,
                              CGSWindowID wid, CGSSurfaceID sid);
extern CGLError CGLGetSurface(CGLContextObj OPENGL_NULLABLE ctx, CGSConnectionID *OPENGL_NULLABLE cid,
                              CGSWindowID *OPENGL_NULLABLE wid, CGSSurfaceID *OPENGL_NULLABLE sid);
extern CGLError CGSSetSurfaceBounds(CGSConnectionID cid, CGSWindowID wid, CGSSurfaceID sid,
                                    CGRect rect);
extern CGLError CGSGetSurfaceBounds(CGSConnectionID cid, CGSWindowID wid, CGSSurfaceID sid,
                                    CGRect *OPENGL_NULLABLE rect);
