...
#pragma warning(disable:4267) /* conversion between size_t and int */
#pragma warning(disable:4244) /* conversion between int64_t and int */
#pragma warning(disable:4306) /* conversion between char const * and int */
#endif
